...
def get_nick_name_plane(context):
    rig = context.active_object
    if rig and rig.type == 'ARMATURE':
        for child in rig.children:
            if child.name == "NickNamePlane":
                return child
    return None
...
class THERIGMOD_OT_DownloadSkin(bpy.types.Operator):
    bl_idname = "therigmod.download_skin"
...
class THERIGMOD_OT_ChangeSkin(bpy.types.Operator, ImportHelper):
    bl_idname = "therigmod.change_skin"
...
class THERIGMOD_PT_MainPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        icon_id = get_icon('therigmodicon')
        if icon_id:
            box.label(text="TheRig Modify", icon_value=icon_id)
        else:
            box.label(text="TheRig Modify", icon='ARMATURE_DATA')
        box.label(text="Author: Zealum")


class THERIGMOD_PT_SkinPanel(bpy.types.Panel):
    bl_label = "Skin"
    bl_idname = "THERIGMOD_PT_skin"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRigMod"
    bl_parent_id = "THERIGMOD_PT_main"
    ...
    def draw(self, context):
        ...
        if texture:
            ...
            layout.operator("therigmod.change_skin", text="Change Skin", icon='FILE_IMAGE')
            layout.operator("therigmod.download_skin", text="Download by Username", icon='URL')
        else:
            layout.label(text="No skin texture found", icon='ERROR')


class THERIGMOD_PT_FacePanel(bpy.types.Panel):
    bl_label = "Face"
    bl_idname = "THERIGMOD_PT_face"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRigMod"
    bl_parent_id = "THERIGMOD_PT_main"
...
class THERIGMOD_PT_FaceEye(bpy.types.Panel):
    bl_label = "Eye"
    bl_idname = "THERIGMOD_PT_face_eye"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRigMod"
    bl_parent_id = "THERIGMOD_PT_face"
    bl_options = {'DEFAULT_CLOSED'}
...
class THERIGMOD_PT_FacePupil(bpy.types.Panel):
    bl_label = "Pupil"
    bl_idname = "THERIGMOD_PT_face_pupil"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRigMod"
    bl_parent_id = "THERIGMOD_PT_face"
...
class THERIGMOD_PT_FaceBrows(bpy.types.Panel):
    bl_label = "Brows"
    bl_idname = "THERIGMOD_PT_face_brows"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRigMod"
    bl_parent_id = "THERIGMOD_PT_face"
...
class THERIGMOD_PT_FaceEyelashes(bpy.types.Panel):
    bl_label = "Eyelashes"
    bl_idname = "THERIGMOD_PT_face_eyelashes"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRigMod"
    bl_parent_id = "THERIGMOD_PT_face"
...
class THERIGMOD_PT_FaceMouth(bpy.types.Panel):
    bl_label = "Mouth"
    bl_idname = "THERIGMOD_PT_face_mouth"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRigMod"
    bl_parent_id = "THERIGMOD_PT_face"
...
class THERIGMOD_PT_FaceSettings(bpy.types.Panel):
    bl_label = "Settings"
    bl_idname = "THERIGMOD_PT_face_settings"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRigMod"
    bl_parent_id = "THERIGMOD_PT_face"
...
class THERIGMOD_PT_LegsPanel(bpy.types.Panel):
    bl_label = "Legs"
    bl_idname = "THERIGMOD_PT_legs"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRigMod"
    bl_parent_id = "THERIGMOD_PT_main"
...
class THERIGMOD_PT_TaperPanel(bpy.types.Panel):
    bl_label = "Taper"
    bl_idname = "THERIGMOD_PT_taper"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRigMod"
...
class THERIGMOD_PT_ArmorPanel(bpy.types.Panel):
    bl_label = "Armor"
    bl_idname = "THERIGMOD_PT_armor"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRigMod"
    bl_parent_id = "THERIGMOD_PT_settings"
...
class THERIGMOD_PT_SettingsPanel(bpy.types.Panel):
    bl_label = "Settings"
    bl_idname = "THERIGMOD_PT_settings"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRigMod"
    bl_parent_id = "THERIGMOD_PT_main"
    ...
    def draw(self, context):
        layout = self.layout
        rig_bone = get_THERIGMOD_bone(context)
        head_bone = get_head_settings_bone(context)
        nick_plane = get_nick_name_plane(context)
        
        if head_bone and "Nick Name" in head_bone:
            layout.prop(head_bone, '["Nick Name"]', text="Nick Name")
        
        if nick_plane and "NickX" in nick_plane:
            layout.prop(nick_plane, '["NickX"]', text="Nick X")
...
classes = [
    THERIGMOD_OT_DownloadSkin,
    THERIGMOD_OT_ChangeSkin,
    THERIGMOD_PT_MainPanel,
    THERIGMOD_PT_SkinPanel,
    THERIGMOD_PT_FacePanel,
    ...
    THERIGMOD_PT_ArmsPanel,
    THERIGMOD_PT_LegsPanel,
