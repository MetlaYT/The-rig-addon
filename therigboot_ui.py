...
class THERIGBOOT_OT_DownloadSkin(bpy.types.Operator):
    bl_idname = "therigboot.download_skin"
...
class THERIGBOOT_OT_ChangeSkin(bpy.types.Operator, ImportHelper):
    bl_idname = "therigboot.change_skin"
...
class THERIGBOOT_PT_MainPanel(bpy.types.Panel):
    bl_label = "TheRigBoot"
    bl_idname = "THERIGBOOT_PT_main"
    ...
    def draw(self, context):
        ...
        if icon_id:
            box.label(text="TheRigBoot", icon_value=icon_id)
        else:
            box.label(text="TheRigBoot", icon='ARMATURE_DATA')
        box.label(text="Author: LibrarianTEAM")


class THERIGBOOT_PT_SkinPanel(bpy.types.Panel):
    bl_label = "Skin"
    bl_idname = "THERIGBOOT_PT_skin"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_main"
    ...
    def draw(self, context):
        ...
        if texture:
            ...
            layout.operator("therigboot.change_skin", text="Change Skin", icon='FILE_IMAGE')
            layout.operator("therigboot.download_skin", text="Download by Username", icon='URL')
        else:
            layout.label(text="No skin texture found", icon='ERROR')


class THERIGBOOT_PT_FacePanel(bpy.types.Panel):
    bl_label = "Face"
    bl_idname = "THERIGBOOT_PT_face"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_main"
...
class THERIGBOOT_PT_FaceEye(bpy.types.Panel):
    bl_label = "Eye"
    bl_idname = "THERIGBOOT_PT_face_eye"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_face"
    bl_options = {'DEFAULT_CLOSED'}
...
class THERIGBOOT_PT_FacePupil(bpy.types.Panel):
    bl_label = "Pupil"
    bl_idname = "THERIGBOOT_PT_face_pupil"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_face"
...
class THERIGBOOT_PT_FaceBrows(bpy.types.Panel):
    bl_label = "Brows"
    bl_idname = "THERIGBOOT_PT_face_brows"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_face"
...
class THERIGBOOT_PT_FaceEyelashes(bpy.types.Panel):
    bl_label = "Eyelashes"
    bl_idname = "THERIGBOOT_PT_face_eyelashes"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_face"
...
class THERIGBOOT_PT_FaceMouth(bpy.types.Panel):
    bl_label = "Mouth"
    bl_idname = "THERIGBOOT_PT_face_mouth"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_face"
...
class THERIGBOOT_PT_FaceSettings(bpy.types.Panel):
    bl_label = "Settings"
    bl_idname = "THERIGBOOT_PT_face_settings"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_face"
...
class THERIGBOOT_PT_BodyPanel(bpy.types.Panel):
    bl_label = "Body"
    bl_idname = "THERIGBOOT_PT_body"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_main"
...
class THERIGBOOT_PT_ArmsPanel(bpy.types.Panel):
    bl_label = "Arms"
    bl_idname = "THERIGBOOT_PT_arms"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_main"
...
class THERIGBOOT_PT_LegsPanel(bpy.types.Panel):
    bl_label = "Legs"
    bl_idname = "THERIGBOOT_PT_legs"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_main"
...
class THERIGBOOT_PT_TaperPanel(bpy.types.Panel):
    bl_label = "Taper"
    bl_idname = "THERIGBOOT_PT_taper"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_settings"
    bl_options = {'DEFAULT_CLOSED'}
...
class THERIGBOOT_PT_ArmorPanel(bpy.types.Panel):
    bl_label = "Armor"
    bl_idname = "THERIGBOOT_PT_armor"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_settings"
...
class THERIGBOOT_PT_SettingsPanel(bpy.types.Panel):
    bl_label = "Settings"
    bl_idname = "THERIGBOOT_PT_settings"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_main"
...
class THERIGBOOT_PT_SimplePanel(bpy.types.Panel):
    bl_label = "Simple"
    bl_idname = "THERIGBOOT_PT_simple"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "TheRig"
    bl_parent_id = "THERIGBOOT_PT_settings"
...
classes = [
    THERIGBOOT_OT_DownloadSkin,
    THERIGBOOT_OT_ChangeSkin,
    THERIGBOOT_PT_MainPanel,
    THERIGBOOT_PT_SkinPanel,
    THERIGBOOT_PT_FacePanel,
    THERIGBOOT_PT_FaceEye,
    THERIGBOOT_PT_FacePupil,
    THERIGBOOT_PT_FaceBrows,
    THERIGBOOT_PT_FaceEyelashes,
    THERIGBOOT_PT_FaceMouth,
    THERIGBOOT_PT_FaceSettings,
    THERIGBOOT_PT_BodyPanel,
    THERIGBOOT_PT_ArmsPanel,
    THERIGBOOT_PT_LegsPanel,
    THERIGBOOT_PT_SettingsPanel,
    THERIGBOOT_PT_SimplePanel,
    THERIGBOOT_PT_TaperPanel,
    THERIGBOOT_PT_ArmorPanel,
]
